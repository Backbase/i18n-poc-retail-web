...
export const INSIGHTS_DASHBOARD_JOURNEY_CONFIGURATION: InsightsDashboardJourneyConfiguration = {
  leftColumnTiles: [{ component: FiDashboardCashflowWrapperComponent, entitlement: PERMISSIONS.canViewCashFlow }],
  rightColumnTiles: [{ component: FiDashboardBudgetWrapperComponent, entitlement: PERMISSIONS.canViewBudgets }],
  globalConfig: {
    currency: 'USD',
    filterDuration: 5,
