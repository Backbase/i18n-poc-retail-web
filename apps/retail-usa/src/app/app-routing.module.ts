  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: $localize`:@@connected-accounts.nav.item.title:Connected Accounts - Transfer`,
          },
          {
            path: '',
            loadChildren: () =>
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: $localize`:@@authorized-users.nav.item.title:Authorized Users`,
          },
          {
            path: 'manage-cards',
            loadChildren: () =>
          ...
          },
          {
            ...
            title: $localize`:@@stop-checks.nav.item.title:Stop Checks`,
          },
          {
      ...
      },
      {
        ...
        data: {
          entitlements: PERMISSIONS.canViewCreditScore,
        },
        title: $localize`:@@credit-score.nav.item.title:Credit-score`,
      },
    ],
