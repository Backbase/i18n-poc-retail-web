...
if (environment.modelbank) {
  ACCOUNTS_TRANSACTIONS_JOURNEY_CONFIGURATION.enableAccountLinking = true;
  ACCOUNTS_TRANSACTIONS_JOURNEY_CONFIGURATION.fastLinkScriptSrc = 'https://cdn.yodlee.com/fastlink/v4/initialize.js';
